...
import com.example.buynow.View.activity.VisualSearchActivity
import com.example.buynow.View.adapter.CoverProductAdapter
import com.example.buynow.View.adapter.ProductAdapter
import com.example.buynow.View.adapter.SaleProductAdapter
...
//    lateinit var coverRecView:RecyclerView
    ...
    override fun onCreateView(
        ...
        val imgsld: ImageSlider = view.findViewById<ImageSlider>(R.id.imgslider)
        val slideModels = java.util.ArrayList<SlideModel>()
        slideModels.add(SlideModel("http://honganhcomputer.online/upload/sliderImage/slideshow_13.jpg", ScaleTypes.FIT))
        slideModels.add(SlideModel("http://honganhcomputer.online/upload/sliderImage/slideshow_9.jpg", ScaleTypes.FIT))
        slideModels.add(SlideModel("http://honganhcomputer.online/upload/sliderImage/slideshow_8.jpg", ScaleTypes.FIT))
        imgsld.setImageList(slideModels, ScaleTypes.FIT)
...
//        coverRecView.visibility = View.VISIBLE
    ...
    private fun setNewProductData() {
        ...
        val jsonFileString = context?.let {
            ...
            getJsonData(it, "ProductLaptop.json")
        }
        val gson = Gson()
