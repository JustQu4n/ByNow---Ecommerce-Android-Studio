package com.example.buynow.View.activity
...
class ProductDetailsActivity : AppCompatActivity() {
    ...
    private fun setProductData() {
        ...
        if (ProductFrom.equals("Cover")) {
            fileJson = "CoverLaptop.json"
        }
        if (ProductFrom.equals("New")) {
            fileJson = "ProductLaptop.json"
        }
        ...
        productPrice_ProductDetailsPage.text = coverD[productIndex].productPrice + "đ"
